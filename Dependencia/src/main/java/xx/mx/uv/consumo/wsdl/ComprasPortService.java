 ...
 * 
 */
@WebServiceClient(name = "comprasPortService", targetNamespace = "t4is.uv.mx/compras", wsdlLocation = "https://compras-production-1f78.up.railway.app/ws/compras.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://compras-production-1f78.up.railway.app/ws/compras.wsdl");
